     <head>
          ...
          <link
               id="pagestyle"
               href="<?php echo base_url('/assets/css/soft-ui-dashboard.css?v=1.0.3')?>"
               rel="stylesheet"
          />
          ...
          >
               ...
               >
                    <ul class="navbar-nav">
                         ...
                         <li class="nav-item">
                              <a class="nav-link <?php echo $this->uri->segment(2) == 'calonAnggota' ? 'active': '' ?>" href="<?php echo site_url('/admin/calonAnggota') ?>">
                                   <div
                                        class="
                                             icon icon-shape icon-sm
                                             shadow
                         ...
                         <li class="nav-item">
                              <a class="nav-link" href="<?php echo site_url('/admin/tambah_user') ?>">
                                   <div
                                        class="
                                             icon icon-shape icon-sm
                                             shadow
